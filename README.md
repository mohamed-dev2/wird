...
npm run test       # Vitest unit tests (203)
...
- **التجربة**: عربي/إنجليزي (RTL/LTR، 968 مفتاحًا بفحص تكافؤ)، فاتح/ليلي/أسود، PWA (تثبيت + عمل دون إنترنت)، حركات هادئة تحترم تقليل الحركة، طباعة للتقارير.
...
app/
  ...
  lib/
    ...
    strings.ts          968-key AR/EN dictionary (religious content stays Arabic)
