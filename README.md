...
npm run test       # Vitest unit tests (246)
...
- **التجربة**: عربي/إنجليزي (RTL/LTR، 979 مفتاحًا بفحص تكافؤ)، فاتح/ليلي/أسود، PWA (تثبيت + عمل دون إنترنت)، حركات هادئة تحترم تقليل الحركة، طباعة للتقارير.
...
app/
  ...
  lib/
    ...
    strings.ts          979-key AR/EN dictionary (religious content stays Arabic)
