...
- **الدين** (`/deen`): رحلة اليوم (أذكار ومهام وأعمال صالحة) + مكتبة وتعلم + مراجعة ليلية tri-state مع درجة ومزاج وامتنان — تُحفظ كسجل يومي، مع سطر سياق ليلي.
...
- **التجربة**: عربي/إنجليزي (RTL/LTR، 1295 مفتاحًا بفحص تكافؤ)، فاتح/ليلي/أسود، PWA (تثبيت + عمل دون إنترنت)، حركات هادئة تحترم تقليل الحركة، طباعة للتقارير.
...
app/
  ...
  lib/
    ...
    strings.ts          1295-key AR/EN dictionary (religious content stays Arabic)
