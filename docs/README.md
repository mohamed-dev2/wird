...
- `features/README.md` — feature-doc index (analytics, coach, return
  system, quran, hadith, adhkar, goals/habits/review, deen journey,
  storage, privacy, security, localization, accessibility, testing).
...
- `../LIMITATIONS.md` — honest boundaries: platform, verification,
  scope, and STEP 10 deen limits.
- `adr/` — Architecture Decision Records:
  ...
  - `adr/ADR-007.md` — deen progression model (levels = tracking depth, XP ≠ reward)
