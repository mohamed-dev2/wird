...
| Full 10-book hadith browser (+ lazy EN)                                                                    | OPTIONAL ONLINE | search/favs of loaded books work                                          | uncached book editions             | calm failed card + retry (`hf.failT/S`), 10s bound                   |
